...
public class TableDAO {
	...
	public Table findById(java.lang.Integer id) {
		...
		try {
			Table instance = (Table) getCurrentSession().get(
					"com.rt.entity.Table", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Table instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.rt.entity.Table")
	...
	public List findByTableNum(Object tableNum) {
		return findByProperty(TABLE_NUM, tableNum);
	}

	public List findByTableState(Object tableState) {
		return findByProperty(TABLE_STATE, tableState);
	}
